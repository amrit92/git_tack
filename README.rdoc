...
The formula to calculate these are.
...
As an extra step, the app also fetches all the data from github and display all the links to the viewer!!

For achieving this, instead of refetching multiple times, all the data is fetched initially and stored in a Redis store and is fetched when required.
This approach is taken keeping in mind that later, extra features like filters and analysis can be done.
